...
public class frmNuevoPaciente extends javax.swing.JFrame {
    ...
    public frmNuevoPaciente(String Nhistoria) {
        initComponents();
        this.setLocationRelativeTo(null);
        con = conectaDB.conectaDB(); 
        CheckBoxEditarDatosGenerales.setVisible(false);
        NumeroHistoria.setText(Nhistoria);
        txtSintomas.setText("sd");
        txtExamenFisico.setText("sd");
        txtIDcampo.setText("sd");
        txtTratamiento.setText("sd");
        txtRp.setText("sd");
        txtIndicaciones.setText("sd");
...
//cargar los doctores en disponibles en el comboBox 
    ...
    private void initComponents() {
        ...
        jPanel3.add(btnNuevoPaciente, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 130, 50));
        ...
        jPanel3.add(btnBuscarPaciente, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 130, 50));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 280, 170, 300));
        ...
        jPanel1.add(CheckBoxEditarDatosGenerales, new org.netbeans.lib.awtextra.AbsoluteConstraints(445, 46, 160, -1));
        ...
        jPanel4.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 820, 510));
        ...
        PanelSignosVitales.add(txtPA, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 20, 80, -1));
        ...
        PanelSignosVitales.add(txtFC, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 70, 80, -1));
        ...
        PanelSignosVitales.add(txtFR, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 120, 80, -1));

        lbFr.setText("FRECUENCIA RESPIRATORIA:");
        PanelSignosVitales.add(lbFr, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 120, -1, -1));

        lbFc.setText("FRECUENCIA CARDIACA:");
        PanelSignosVitales.add(lbFc, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 70, -1, 20));

        lbPA.setText("PRECION ARTERIAL:");
        PanelSignosVitales.add(lbPA, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 20, -1, -1));

        jLabel3.setText("Kg");
        PanelSignosVitales.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 120, -1, 20));

        jLabel2.setText("Cm");
        PanelSignosVitales.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 70, 20, -1));
        ...
        PanelSignosVitales.add(txtTALLA, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 70, 80, -1));
        ...
        PanelSignosVitales.add(txtPESO, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 120, 80, -1));

        lbPeso.setText("PESO:");
        PanelSignosVitales.add(lbPeso, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 120, 40, -1));

        lbTalla.setText("TALLA:");
        PanelSignosVitales.add(lbTalla, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 70, -1, -1));

        PanelSignosVitales.add(ComboBoxDoctores, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 30, 240, -1));

        jLabel18.setText("DOCTORES");
        PanelSignosVitales.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, -1, -1));
        ...
        jPanel2.add(PanelGestacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 180, 270));
        ...
        jPanel2.add(PanelNuevaGesta, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 190, 590, 270));
        ...
        getContentPane().add(btnRecetaMedica, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 230, 170, -1));
    ...
    private void btnGuardarHistoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarHistoriaActionPerformed
        ...
        if (CheckBoxEditarDatosGenerales.isSelected() || valorParaModificarSoloLaHistoria.getText()=="1234") {
                       ...
                       sqlConsulta ="INSERT INTO consulta_hombre(\n" +
                        ...
                        "            '"+txtFR.getText()+"','"+lbFechaActualTxt.getText()+"','"+txtSintomas.getText()+"','"+txtExamenFisico.getText()+"', \n" +
                        "            '"+txtIDcampo.getText()+"','"+txtTratamiento.getText()+"','"+txtRp.getText()+"','"+txtIndicaciones.getText()+"','"+ComboBoxDoctores.getSelectedItem()+"');";
        ...
        if (CheckBoxEditarDatosGenerales.isSelected() || valorParaModificarSoloLaHistoria.getText()=="1234" ) {
                       ...
                       sqlConsulta ="INSERT INTO consulta_mujer_gesta(\n" +
                        ...
                        "    VALUES ('"+NumeroHistoria.getText()+"','"+txtGesta.getText()+"','"+ComboBoxCesarea.getSelectedItem()+"','"+ComboBoxParto.getSelectedItem()+"', \n" +
                        "            '"+ComboBoxAborto.getSelectedItem()+"','"+txtFUM.getText()+"');";
                       ...
                       sqlConsultaGesta="INSERT INTO tratamiento_mujer(\n" +
                        ...
                        "            '"+txtFC.getText()+"','"+txtFR.getText()+"','"+txtSintomas.getText()+"','"+txtExamenFisico.getText()+"', \n" +
                        "            '"+txtIDcampo.getText()+"','"+txtTratamiento.getText()+"','"+txtRp.getText()+"','"+txtIndicaciones.getText()+"','"+ComboBoxDoctores.getSelectedItem()+"','"+txtGesta.getText()+"');";
    ...
    private void btnRecetaMedicaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRecetaMedicaActionPerformed
        ...
        try {
            ...
            p.put("nombrePaciente", txtApellidos.getText()+" "+txtNombres.getText());
    ...
    //comprobacion para ver si el paciente es hombre o mujer
    public void comprobacion(){
     if (ComboBoxSexo.getSelectedItem() == "Masculino" ){
         PanelGestacion.setVisible(false);
         PanelNuevaGesta.setVisible(false);
     }else{
         PanelGestacion.setVisible(true);
         PanelNuevaGesta.setVisible(true);
     }
    }
...
//                new frmNuevoPaciente().setVisible(true);
    ...
    private javax.swing.JPanel PanelGestacion;
    private javax.swing.JPanel PanelNuevaGesta;
